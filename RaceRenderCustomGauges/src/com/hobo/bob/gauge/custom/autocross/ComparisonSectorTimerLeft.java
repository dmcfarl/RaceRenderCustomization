...
if(NumSplits >= 0) {
	...
	DrawText(FormatNumber(SectorTime, 3), SectorX1, Y, RunColor, FontSize, AlignH_Right);
	...
	if(LapTime > PrevSplit1 && LapTime > CurrSplit1) {
		...
		DrawText(FormatNumber(SectorTime, 3), SectorX2, Y, SplitColor, FontSize, AlignH_Right);
	}
	Y -= SectorY;
}
if(NumSplits >= 1) {
